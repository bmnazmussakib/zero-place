...
export default function ServicesHeroCTA() {
    ...
    return (
        ...
        >
            ...
            <motion.h1
                variants={fadeInUp}
                className="text-5xl md:text-6xl lg:text-7xl font-bold font-heading mb-6 tracking-tight text-[#0f0e21]"
            >
                Scale your success with outstanding design
            </motion.h1>
            <motion.p
                variants={fadeInUp}
                className="text-xl md:text-2xl text-[var(--text-body)] max-w-3xl mx-auto mb-10 leading-relaxed"
            >
