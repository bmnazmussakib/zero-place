...
export default function ServicePricing() {
    ...
    return (
        <section className="relative py-20 md:py-28 bg-gradient-to-br from-[#6c46fd]/5 via-white to-indigo-50/40 overflow-hidden">
            ...
            <div className="relative  px-5 sm:px-8 lg:px-10">
                ...
                <div
                    className="
            relative overflow-hidden rounded-[3rem] md:rounded-[4rem] lg:rounded-[5rem]
            bg-gradient-to-br from-[#6c46fd]/80 via-indigo-600 to-purple-700
          ...
          "
                >
                    ...
                    <div className="mt-20 md:mt-24 lg:mt-28 max-w-3xl">
